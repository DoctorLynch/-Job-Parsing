...
class Vacancies:
    ...
    def to_dict(self):
        """
        Преобразование объекта в словарь для корректной работы JSON-saver
        """
        data = {
            "title": self.title,
            "url": self.url,
    ...
    def format_salary(self):
        """
        Форматирования данных о зарплате и представления
        в читабельном виде.
        """
    ...
    def get_description(self):
        """
      Корректировка описания вакансии и представление
        в читабельном виде
        """
        if self.api_url:
