...
from func.func_parser import all_from_hh, all_from_sj
from func.utils import add_vacancies_to_json_file, get_keywords_from_user, sorted_vacancies_by_keywords, \
    sorted_vacancies_by_salary, print_vacancy_info, get_top_vacancies, remove_vacancies_from_json_file

FILE_NAME = "vacancies.json"


def process_action(vacancies_list, action, file_name, user_platform):
    """
    ...
    if action == "1":
        ...
        if user_platform == "1":
            ...
            filtered_vacancies_hh = sorted_vacancies_by_keywords(vacancies_list, keywords_hh)
            ...
            filtered_vacancies_sj = sorted_vacancies_by_keywords(vacancies_list, keywords_sj)
        ...
        if user_platform == "1":
            filtered_vacancies_by_salary = sorted_vacancies_by_salary(vacancies_list, desire_salary)
        ...
        if action == "6":
            ...
            while user_input != "4":
                ...
                if user_input == "1":
                    ...
                    get_top_vacancies(FILE_NAME, criteria_input)
